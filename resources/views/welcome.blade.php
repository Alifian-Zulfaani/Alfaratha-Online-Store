...
<body class="bg-gray-200 text-black" style="font-family: roboto">
    <!-- Navbar -->
    <nav
        class="fixed top-0 left-0 right-0 z-50 bg-black bg-opacity-80 border-b border-yellow-600 px-4 md:px-8 py-6 flex justify-between items-center">
        <a href="#" class="text-white italic font-bold text-lg md:text-2xl"
            style="font-family: sans-serif">Alfaratha<span class="text-yellow-600">Store</span></a>
        ...
        <div class="hidden md:flex space-x-8">
            ...
            <a href="/admin" class="text-white text-lg hover:text-yellow-600 hidden">Login Admin</a>
        </div>
    ...
    <div id="side-menu"
        class="fixed top-0 right-0 w-64 h-full bg-black bg-opacity-90 z-40 transform translate-x-full transition-transform duration-300 ease-in-out">
        <div class="p-6">
    ...
    <section id="home" class="min-h-screen flex items-center justify-center bg-cover bg-center"
        style="background-image: url('../img/header-main-bg.jpg');">
        <div class="max-w-4xl text-center">
            <h1 class="text-4xl md:text-6xl font-bold text-gray-800">Selamat Datang di <span
                    class="text-yellow-600">Toko Kami</span></h1>
            <p class="text-lg md:text-2xl mt-4 text-gray-800">Menyediakan berbagai macam oleh-oleh haji dan umroh.</p>
            <a href="#products"
                class="mt-6 inline-block bg-yellow-600 text-white py-3 px-6 rounded hover:bg-yellow-700">Beli Yuk</a>
        </div>
    </section>
    ...
    <section id="about" class="py-20 px-8 bg-white">
        ...
        <div class="md:flex md:space-x-10">
            ...
            <div class="md:w-1/2 mt-6 md:mt-0">
                <p class="text-gray-700 leading-7">Alfaratha Store merupakan sebuah toko bagi para jamaah haji dan umroh
                    yang mencari oleh-oleh khas. Di sini, pengunjung dapat menemukan berbagai macam produk berkualitas,
                    mulai dari kurma yang manis dan lezat, air zam zam yang penuh berkah, hingga kismis yang kaya
                    nutrisi. Selain itu, tersedia juga kacang dan almond yang menjadi camilan sehat dan nikmat untuk
                    dibawa pulang. Setiap produk dipilih dengan cermat untuk memastikan keaslian dan cita rasanya.</p>
                <p class="text-gray-700 leading-7 mt-3">Tidak hanya menawarkan berbagai pilihan oleh-oleh, Alfaratha
                    Store juga memberikan pengalaman belanja yang nyaman dan ramah. Staf yang berpengalaman siap
                    membantu pengunjung dalam memilih oleh-oleh yang tepat sesuai kebutuhan. Dengan suasana yang hangat
                    dan penuh keakraban, Alfaratha Store bukan hanya sekadar tempat berbelanja, tetapi juga menjadi
                    bagian dari perjalanan spiritual yang tak terlupakan bagi setiap jamaah.</p>
            </div>
        </div>
    </section>
            ...
            @foreach ($products as $product)
                <div class="w-[300px] h-[300px] md:w-1/4 px-6 text-center rounded-full mb-2 md:mb-4">
                    <img src="{{ Storage::url($product->image) }}"
                        class="w-1/2 h-1/2 md:w-3/4 md:h-3/4 object-fit rounded-full mx-auto mb-2 md:mb-4 transform hover:scale-105 transition-transform duration-300"
                        alt="{{ $product->name }}" />
    ...
    <section id="contact" class="p-20 bg-white">
        ...
        <div class="flex flex-col md:flex-row items-start justify-center md:space-x-10">
            <iframe class="md:w-1/2 w-full h-80 rounded"
                src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d247.12065099873277!2d110.6395953223239!3d-7.690617166681025!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sid!2sid!4v1674222984599!5m2!1sid!2sid"
                allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            <form class="md:w-1/2 w-full mt-8 md:mt-0 bg-gray-100 p-8 rounded" onsubmit="sendWhatsAppMessage(event)">
                <div class="mb-4">
                    <input type="text" id="nama" class="w-full p-4 rounded border border-gray-400"
                        placeholder="Tulis Nama" required />
                </div>
                <div class="mb-4">
                    <textarea id="pesan" class="w-full p-4 rounded border border-gray-400" placeholder="Tulis Pesan" rows="5"
                        required></textarea>
                </div>
                <button type="submit" class="w-full bg-yellow-600 text-white py-4 rounded hover:bg-yellow-700">Kirim
